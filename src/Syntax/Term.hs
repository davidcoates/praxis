...
declTerm = internal declTermFn <|> declTermRec <|> declTerm' <|> mark "term declaration/definition" where
  declTerm' = prefix varId (_DeclTermSig, declTermSig) (_DeclTermDef, declTermDef) <|> internal declTermVar <|> mark "non-rec term declaration/definition"
